...
<html>
<head>
<title>Rejected posts | Global3dmod</title>
...
<spring:message code="moderator.rejectingpost.messagefortable" var="messagefortable" />
<spring:message code="moderator.postsunpublished.posts" var="posts"/>
...
<!-- Here some place for ads. After placing ads you may delete "placeforads" css class in header -->
 ...
 <div class="row footerpadding">
  ...
  <a href="<c:url value="/moderator/rejectingPosts" />" class="list-group-item active"> <i class="fa fa-ban"></i> ${rejectingposts}</a>
      ...
      <a href="<c:url value="/moderator/rejectingPosts?sort=${sortType}&page=${thisPage+1}&desc=${descPage}" />" aria-label="Next">
        <span aria-hidden="true">&raquo;</span>
                             ...
                             <tr>
                                  ...
                                  <td style="width: 3em;">${post.rejectMessage.message}</td>
                              </tr>
                              </c:forEach>
                              </tbody>
                          </table>
