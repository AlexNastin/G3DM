				...
				<div class="col-md-12 nopadding2">
					<div class="content-panel">
						...
						${addadvertisement}
							...
							<a href="<c:url value="/admin/addDefaultAdvertisement" />" class="btn btn-info admin-addModerator-float"> <i class="fa fa-user-plus"></i>
							...
							<tbody>
								<c:forEach items="${listAdvertisementsLimit10}" var="advertisement">
									<tr>
										...
										<td><img style="max-width: 100px;" alt="" src="<c:url value="${advertisement.filePath}" />"></td>
