...
<spring:message code="moderator.menu.complainedposts"
	var="complainedposts" />
<spring:message code="moderator.moderationpost.postfortitle"
	var="postfortitle" />
<spring:message code="form.image" var="image" />
<spring:message code="moderator.complainpost.designer"
	var="designerfortable" />
...
<spring:message code="designer.updatepost.technologies"
	var="technologies" />
<spring:message code="moderator.complainpost.uploaddate"
	var="uploaddate" />
<spring:message code="moderator.complainpost.changedate"
	var="changedate" />
<spring:message code="moderator.complainpost.designerprogram"
	var="designerprogram" />
...
<spring:message code="moderator.complainpost.confirmpublishing"
	var="confirmpublishing" />
<spring:message code="moderator.complainpost.typeyourmessagehere"
	var="typeyourmessagehere" />
<spring:message code="moderator.complainpost.sendmessage"
	var="sendmessage" />
<spring:message code="moderator.complainpost.messagetodesigner"
	var="messagetodesigner" />
		...
		<div class="col-md-2 nopadding1">
			<div class="list-group">
				<img src="<c:url value="${user.avatar.avatarPath}" />"
					...
					class="fa fa-exclamation-triangle"></i> ${unpblsd}
				...
				<div class="col-md-12 nopadding2">
					<div class="col-md-4" style="padding-left: 0px;">
						...
						<div class="col-md-12">
							...
							<button type="button" data-toggle="modal" data-target="#publish"
								class="btn btn-success left-designer btn-lg">${publish}</button>
		...
		<div class="modal-dialog">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					<form:form id="rejectMessageForm" name="rejectMessageForm"
						class="form-horizontal" modelAttribute="rejectMessageForm"
						method="POST">
						...
						<div class="height-input-string-messages">
							...
							<label class="error" generated="true" for="text"
								style="font-size: 9pt; line-height: 1.2;"></label>
						</div>
						<form:input type="hidden" id="idPost" name="idPost" path="idPost"
							value="${post.idPost }"></form:input>
