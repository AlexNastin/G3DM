package com.global3Dmod.«Dmodel.service.impl;
...
import com.global3Dmod.«Dmodel.aop.annotation.AspectLogG3DM;
import com.global3Dmod.«Dmodel.dao.IAvatarDAO;
import com.global3Dmod.«Dmodel.dao.ICategoryDAO;
import com.global3Dmod.«Dmodel.dao.ICountryDAO;
import com.global3Dmod.«Dmodel.dao.IDisProgramDAO;
import com.global3Dmod.«Dmodel.dao.IPostDAO;
import com.global3Dmod.«Dmodel.dao.ITechnologyDAO;
import com.global3Dmod.«Dmodel.dao.IUserDAO;
...
import com.global3Dmod.«Dmodel.service.ServiceParamConstant;
import com.global3Dmod.«Dmodel.service.helper.ServiceHelper;
import com.global3Dmod.«Dmodel.sort.country.SortedCountriesById;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsByCategory;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsByCategoryDesc;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsByDate;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsByDateDesc;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsByDownloads;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsByDownloadsDesc;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsByStatus;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsByStatusDesc;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsBySubcategory;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsBySubcategoryDesc;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsByTitle;
import com.global3Dmod.«Dmodel.sort.post.SortedPostsByTitleDesc;
...
public class DesignerService implements IDesignerService {
	...
	public void addPost(PostForm postForm, int idUser, String nickName, String serverPath) throws ServiceException {
		...
		com.global3Dmod.«Dmodel.domain.File file = new com.global3Dmod.«Dmodel.domain.File();
		file.setFolder(time);
	...
	public void updatePost(UpdatePostForm updatePostForm, Integer idPost, String serverPath) throws ServiceException {
		try {
			...
			if (!updatePostForm.getModelUpdate().isEmpty()) {
				...
				String fullPathModel = serverPath.concat(pathModel);
				com.global3Dmod.«Dmodel.domain.File file = post.getFile();
